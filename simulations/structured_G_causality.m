...
%pre = name_fold(4:10);
folder_bold = ['/media/alecrimi/PrionAtlas3/test_fmriprep2/ses-DS2/func/' ];
bold_file = load_untouch_nii([folder_bold 'sub-A00035072_ses-DS2_task-rest_acq-CAP_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold.nii.gz']);   
...
atlas_file = load_untouch_nii([folder_bold 'atlas_reg.nii.gz']); % 'PP264_all_ROIs_combined.nii'
atlas = atlas_file.img;

%mask_file = load_untouch_nii([folder_bold 'sub-A00035072_ses-DS2_task-rest_acq-CAP_space-MNI152NLin2009cAsym_res-2_desc-brain_mask.nii.gz']);
%mask_im = mask_file.img;
...
connectome_folder = ['/media/alecrimi/PrionAtlas3/test_fmriprep2/ses-DS2/dwi/' ];
